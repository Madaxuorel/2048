...
struct cooscore droitemvt(int tab[6][6], int i, int y, int n, int t, struct cooscore cooa,int k);
struct cooscore hautmvt(int tab[6][6], int i, int y, int n, int t, struct cooscore cooa);
struct cooscore basmvt(int tab[6][6], int i, int y, int n, int t, struct cooscore cooa, int k);

struct coo randstart(clock_t clock, int n);

void AppliquerGraph(int tab[6][6], int n);
struct coo apply(struct coo coo, int n);
int fin(int tab[6][6]);
int close(int tab[6][6]);
void transf(int entree[16], int sortie[4][4], int n);

void sauvgd(int tab[6][6], int n);
void gettab(int ints[36], int n);
void reset(int tab[6][6], int n);
void resetsauv();
void affscore(int score, SDL_Rect rectscore);
...
void AscoreFINAL(int cont, struct cooscore cooa, SDL_Rect rectscore);
...
struct coo apply2j(struct coo coo, int j );
void sauvgd(int tab[4][4], int tab2[4][4]);
void reset(int tab[4][4], int tab2[4][4]);
struct coo randstart(clock_t clock);

void AppliquerGraph2j(int tab1[4][4], int tabj[4][4]);
int inverse(int j);
struct win fin2j(int tab1[4][4], int tab2[4][4]);
